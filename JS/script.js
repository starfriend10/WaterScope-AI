...
function startTimer(type = 'processing') {
  ...
  timerStartTime = type === 'warmup' ? ensureSharedModelTimerStarted() : Date.now();
...
// --- 1. Load CSV ---
Papa.parse("https://raw.githubusercontent.com/starfriend10/WaterScope-AI/main/Data/Decarbonization_MCQA.csv", {
    download: true,
    header: true,
    skipEmptyLines: true,
